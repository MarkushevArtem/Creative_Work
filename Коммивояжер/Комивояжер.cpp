...
void OutAnswer(int*** mat, int n, int** help, int* result)
{
...
void drawCircle(int x, int y, int R) //задаем координаты круга и рисуем его
{
...
void drawLine(int text, int x0, int y0, int x1, int y1) //ребро неориентированного взвешенного граф
{
...
void drawMenu()
{
	...
	glBegin(GL_QUADS);
	glVertex2i(1100, WinH - 50);
	glVertex2i(1100, WinH - 100);
	glVertex2i(1300, WinH - 100);
	glVertex2i(1300, WinH - 50);
	glEnd();
	glColor3d(0, 0, 0);
	drawMenuText("New element", 1145, WinH - 60);

	glColor3d(1.0, 1.0, 0.0);
	glBegin(GL_QUADS);
	glVertex2i(1100, WinH - 150);
	glVertex2i(1100, WinH - 200);
	glVertex2i(1300, WinH - 200);
	glVertex2i(1300, WinH - 150);
	glEnd();
	glColor3d(0, 0, 0);
	drawMenuText("Delete element", 1140, WinH - 160);


	glColor3d(1.0, 1.0, 0.0);
	glBegin(GL_QUADS);
	glVertex2i(1100, WinH - 250);
	glVertex2i(1100, WinH - 300);
	glVertex2i(1300, WinH - 300);
	glVertex2i(1300, WinH - 250);
	glEnd();
	glColor3d(0, 0, 0);
	drawMenuText("Matrix", 1170, WinH - 260);

	glColor3d(1.0, 1.0, 0.0);
	glBegin(GL_QUADS);
	glVertex2i(1100, WinH - 350);
	glVertex2i(1100, WinH - 400);
	glVertex2i(1300, WinH - 400);
	glVertex2i(1300, WinH - 350);
	glEnd();
	glColor3d(0, 0, 0);
	drawMenuText("Get result", 1155, WinH - 360);

	glColor3d(1.0, 1.0, 0.0);
	glBegin(GL_QUADS);
	glVertex2i(1100, WinH - 450);
	glVertex2i(1100, WinH - 500);
	glVertex2i(1300, WinH - 500);
	glVertex2i(1300, WinH - 450);
	glEnd();
	glColor3d(0, 0, 0);
	drawMenuText("New Graph", 1150, WinH - 460);
